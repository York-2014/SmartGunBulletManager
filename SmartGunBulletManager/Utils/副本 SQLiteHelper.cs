...
namespace SmartGunBulletManager.Utils
{
    ...
    public class SQLiteHelper
    {
        ...
        public static void AssignParameterValues(IDataParameterCollection commandParameters, DataRow dataRow)
        {
            ...
            foreach (IDataParameter commandParameter in commandParameters)
            {
                ...
                {
                    throw new InvalidOperationException(string.Format("Please provide a valid parameter name on the parameter #{0},the ParameterName property has the following value: '{1}'.",
        ...
        public static void AssignParameterValues(IDataParameter[] commandParameters, params  object[] parameterValues)
        {
